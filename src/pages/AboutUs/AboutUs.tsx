        ...
        <ScrollAnimation>
          <section className="about-us-statement">
            <div className="about-us-content">
              ...
              <ScrollAnimation>
              <p className="about-us-text">
                Currently, the children under our care come to our center each morning to receive meals – breakfast, lunch, 
                and dinner – and participate in learning and worship activities.  
                However, after dinner, they must return to unsafe and unstable living conditions, 
              ...
              <p className="about-us-text">
                ...
                With the support of Christ Chapel Church and other partners, we aim to create a loving, 
